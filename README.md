...
옵니다 — 우즈베크어는 [어떤 TTS 도 만들지 못하기](#목소리를-새로-만들-수-있는-언어)
때문입니다. 이미 우즈베크어로 녹음된 소리라 립싱크가 진짜와 거의 같아지고,
값도 0원입니다.
...
**우즈베크어는 없습니다.** 그래서 이 파이프라인은 목소리를 만들지 않고 원본
mp4 에서 떼어 옵니다. 나중에 TTS 를 붙인다 해도 그때도 **아래 31개 안에서만**
됩니다 (슈퍼톤 Supertonic 3 기준, 2026-09 확인).

...
| | 어떻게 | 값 |
|---|---|---|
| **웹 드래그드랍** (기본) | `05\bundleNN\올릴음성.mp3` 를 HeyGen 웹에 올려 렌더하고, 받은 영상을 그 폴더에 되돌려 놓습니다 | 구독 크레딧 — **모델 IV 는 분당 16 크레딧** (V 는 47) |
| API | 화면에서 바로 부릅니다 | **모델 IV 는 분당 $3.00** · V $4.00 · III $1.00 |
...
**모델을 V 로 올리면 3배**입니다. 45분 강의 한 편이면 IV 약 720 크레딧,
V 약 2,130 크레딧입니다 — 한 번 굽기 전에 어느 모델인지 확인하세요.
